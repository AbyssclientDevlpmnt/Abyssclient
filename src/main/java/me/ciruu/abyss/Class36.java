...
public class Class36 {
    ...
    public static int Method260() {
        if (Manager.moduleManager.isModuleEnabled(CustomFont.class)) {
            return (Boolean)((CustomFont)Manager.moduleManager.getModuleByClass(CustomFont.class)).newfontrenderer.getValue() != false ? Class36.Field462.FONT_HEIGHT : Field460.Field311;
        }
