...
public class Class110 {
    ...
    public static void Method1088(BlockPos blockPos, EnumHand enumHand) {
        ...
        for (EnumFacing enumFacing : EnumFacing.values()) {
            ...
            if (!Class110.Method2174(blockPos2) || vec3d.squareDistanceTo(vec3d2 = new Vec3d((Vec3i)blockPos2).add(null).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5))) > 18.0625) continue;
    ...
    public static Class109 Method2183(BlockPos blockPos, float f, boolean bl, boolean bl2, boolean bl3, EnumHand enumHand) {
        ...
        for (EnumFacing enumFacing : EnumFacing.values()) {
            ...
            if (!Class110.Field1795.world.getBlockState(blockPos2).getBlock().canCollideCheck(Class110.Field1795.world.getBlockState(blockPos2), false) || !(class285.distanceTo(vec3d = new Vec3d((Vec3i)blockPos2).add(null).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5))) <= (double)f)) continue;
