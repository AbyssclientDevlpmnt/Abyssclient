...
public final class Class248 {
    ...
    public final AxisAlignedBB Field666;
    ...
    public Class248(ChunkLogger chunkLogger, SPacketChunkData sPacketChunkData) {
    ...
    public void Method947(SPacketChunkData sPacketChunkData) {
