...
public class Class308 {
    public static List Method2661(float f) {
        ...
        nonNullList.addAll((Collection)Class308.Method2662(Class30.Method209((EntityPlayer)Globals.mc.player), f, (int)f, false, true, 0).stream().filter(null).collect(Collectors.toList()));
        return nonNullList;
    }

    public static List Method2664(float f, boolean bl) {
        NonNullList nonNullList = NonNullList.create();
        nonNullList.addAll((Collection)Class308.Method2662(Class30.Method209((EntityPlayer)Globals.mc.player), f, (int)f, false, true, 0).stream().filter(arg_0 -> Class308.Method2665(bl, null)).collect(Collectors.toList()));
        return nonNullList;
    }

    public static List Method2666(float f, boolean bl, boolean bl2) {
        NonNullList nonNullList = NonNullList.create();
        nonNullList.addAll((Collection)Class308.Method2662(Class30.Method209((EntityPlayer)Globals.mc.player), f, (int)f, false, true, 0).stream().filter(arg_0 -> Class308.Method2667(bl, bl2, null)).collect(Collectors.toList()));
        return nonNullList;
    }
