...
extends WebSocketClient {
    ...
    private final Thread getReadThread() throws NoSuchFieldException, IllegalAccessException {
    ...
    private final Thread getWriteThread() throws NoSuchFieldException, IllegalAccessException {
