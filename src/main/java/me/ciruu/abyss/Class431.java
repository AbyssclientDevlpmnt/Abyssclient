...
extends Module {
    ...
    public static AxisAlignedBB axisAlignedBB;
    ...
    private void Method1824(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        switch ((Class433)((Object)this.Field1423.getValue())) {
            case Yes: {
                ...
                if (Class30.Method1834() || Class30.Method1835() || eventPlayerUpdateWalking.getEra() != Class53.PRE) break;
