...
extends Module {
    ...
    private final Setting size = new Setting("Size", "", this, Float.valueOf(40.0f), Float.valueOf(5.0f), Float.valueOf(60.0f), this.mainwindow, null);
    private final Setting custom = new Setting("Custom", "", (Module)this, (Object)false, this.mainwindow, null);
    ...
    public CustomFont() {
        ...
        if (((Boolean)this.custom.getValue()).booleanValue()) {
            try {
                Class36.Method553(new Class198(new Font((String)this.font.getValue(), ((Class363)((Object)this.type.getValue())).ordinal(), ((Float)this.size.getValue()).intValue()).deriveFont(((Float)this.size.getValue()).floatValue())));
            }
