...
extends Module {
    ...
    private final Setting rspeedline = new Setting("RSpeedLine", "", this, Float.valueOf(7.0f), Float.valueOf(0.001f), Float.valueOf(10.0f), this.rainbow, null);
    private final Setting rsatline = new Setting("RSatLine", "", this, Float.valueOf(0.5f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.rainbow, null);
    private final Setting rbrightline = new Setting("RBrightLine", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.rainbow, null);
    public final Setting gradientline = new Setting("GradientLine", "", (Module)this, (Object)false, this.rainbow, null);
    ...
    public final Setting rspeedenabled = new Setting("RSpeedEnabled", "", this, Float.valueOf(7.0f), Float.valueOf(0.001f), Float.valueOf(10.0f), this.rainbow, null);
    public final Setting rsatenabled = new Setting("RSatEnabled", "", this, Float.valueOf(0.5f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.rainbow, null);
    public final Setting rbrightenabled = new Setting("RBrightEnabled", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.rainbow, null);
    public final Setting gradientenabled = new Setting("GradientEnabled", "", (Module)this, (Object)false, this.rainbow, null);
    ...
    public final Setting backgroundgradient = new Setting("Gradient", "", (Module)this, (Object)true, this.backgroundwindow, null);
