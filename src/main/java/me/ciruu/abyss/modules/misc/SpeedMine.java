...
extends Module {
    ...
    private final Setting delay = new Setting("Delay", "", this, 0, 0, 500, this.mainwindow, null);
    private final Setting rotate = new Setting("Rotate", "", (Module)this, (Object)false, this.mainwindow, null);
    private final Setting linewidth = new Setting("LineWidth", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(10.0f), this.mainwindow, null);
    ...
    private void Method3428(EventPlayerUpdate eventPlayerUpdate) {
        ...
        if (((Boolean)this.reset.getValue()).booleanValue() && Globals.mc.gameSettings.keyBindUseItem.isKeyDown()) {
            Globals.mc.playerController.getIsHittingBlock();
        }
    }
