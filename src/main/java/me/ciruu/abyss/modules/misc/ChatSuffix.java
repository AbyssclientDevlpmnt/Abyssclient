...
extends Module {
    ...
    private final Setting suffix = new Setting("Suffix", "Suffix", (Module)this, (Object)"Abyss", this.main, null);
    @EventHandler
    ...
    private void Method3899(EventNetworkPostPacketEvent eventNetworkPostPacketEvent) {
        if (eventNetworkPostPacketEvent.getPacket() instanceof CPacketChatMessage && !(Globals.mc.currentScreen instanceof Class39)) {
            ...
            CPacketChatMessage packet = (CPacketChatMessage) eventNetworkPostPacketEvent.getPacket();
        }
    }
}
