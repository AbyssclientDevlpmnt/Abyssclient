...
extends Module {
    ...
    public final Setting offset = new Setting("Offset", "", this, Float.valueOf(0.1f), Float.valueOf(0.0f), Float.valueOf(10.0f), this.mainwindow, null);
    ...
    private final Setting enableticks = new Setting("EnableTicks", "", this, 10, 1, 100, this.mainwindow, null);
    private final Setting waitticks = new Setting("WaitTicks", "", this, 10, 1, 100, this.mainwindow, null);
    ...
    private final Setting height = new Setting("Height", "", this, Float.valueOf(127.0f), Float.valueOf(0.0f), Float.valueOf(256.0f), this.mainwindow, null);
    ...
    private void Method2864(EventPlayerTravel eventPlayerTravel) {
        ...
        if (((Boolean)this.spoofpackets.getValue()).booleanValue()) {
            Vec3d vec3d = entity.getPositionVector().add(null);
    ...
    private void Method2862(EventNetworkPostPacketEvent eventNetworkPostPacketEvent) {
        ...
        if ((eventNetworkPostPacketEvent.getPacket() instanceof CPacketPlayer.Rotation && ((Boolean)this.cancelrotations.getValue()).booleanValue() || eventNetworkPostPacketEvent.getPacket() instanceof CPacketInput) && Globals.mc.player.isRiding()) {
        ...
        if (eventNetworkPostPacketEvent.getPacket() instanceof CPacketVehicleMove && ((Boolean)this.limit.getValue()).booleanValue() && this.mode.getValue() == Class571.Packet) {
