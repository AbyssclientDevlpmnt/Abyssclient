...
extends Module {
    ...
    private void Method3595(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        ...
        } else if (this.mode.getValue() == Class393.NCP && this.Field2925.player.collidedHorizontally && this.Field2925.player.onGround && this.Field2925.player.fallDistance == 0.0f && !this.Field2925.player.onGround && !this.Field2925.player.isOnLadder() && !this.Field2925.player.movementInput.jump) {
