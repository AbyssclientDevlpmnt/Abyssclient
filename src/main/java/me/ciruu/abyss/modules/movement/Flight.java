...
extends Module {
    ...
    public final Setting movingglide = new Setting("MovingGlide", "If no binds are pressed, this, should glide be enabled?", (Module)this, (Object)false, this.mainwindow, null);
    public final Setting glidespeed = new Setting("GlideSpeed", "Glide speed of going down", this, Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(10.0f), this.mainwindow, null);
