...
extends Module {
    ...
    private void Method334(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        if (eventPlayerUpdateWalking.getEra() != Class53.PRE || Manager.moduleManager.isModuleEnabled(PacketFly.class)) {
            return;
        }
        ...
        if (!(iBlockState.getBlock() != Blocks.BEDROCK && iBlockState.getBlock() != Blocks.OBSIDIAN && !((Boolean)this.anyblock.getValue()).booleanValue() || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
            if (Globals.mc.player.onGround && this.mode.getValue() == Class123.Motion) {
                Globals.mc.player.motionY -= 1.0;
            }
            if (!(this.mode.getValue() != Class123.Timer || !this.Field293 || Globals.mc.player.onGround || !(Globals.mc.player.motionY < -0.1) || this.Field292 || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
                Manager.Field298.Method337(((Float)this.timer.getValue()).floatValue());
                this.Field292 = true;
            }
        } else if (!(iBlockState2.getBlock() != Blocks.BEDROCK && iBlockState2.getBlock() != Blocks.OBSIDIAN && !((Boolean)this.anyblock.getValue()).booleanValue() || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
            if (Globals.mc.player.onGround && this.mode.getValue() == Class123.Motion) {
                Globals.mc.player.motionY -= 1.0;
            }
            if (!(this.mode.getValue() != Class123.Timer || !this.Field293 || Globals.mc.player.onGround || !(Globals.mc.player.motionY < -0.1) || this.Field292 || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
        ...
        } else if (!(iBlockState3.getBlock() != Blocks.BEDROCK && iBlockState3.getBlock() != Blocks.OBSIDIAN && !((Boolean)this.anyblock.getValue()).booleanValue() || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
            if (Globals.mc.player.onGround && this.mode.getValue() == Class123.Motion) {
                Globals.mc.player.motionY -= 1.0;
            }
            if (!(this.mode.getValue() != Class123.Timer || !this.Field293 || Globals.mc.player.onGround || !(Globals.mc.player.motionY < -0.1) || this.Field292 || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
        ...
        if (this.Field292 && (Globals.mc.player.onGround || Globals.mc.player.isInLava() || Globals.mc.player.isInWater() || Globals.mc.player.onGround || Globals.mc.player.isElytraFlying() || Globals.mc.player.capabilities.isFlying)) {
            this.Field292 = false;
