...
extends Module {
    ...
    public final Setting speed = new Setting("Speed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.main, null);
    public final Setting saturation = new Setting("Saturation", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.main, null);
    public final Setting brightness = new Setting("Brightness", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.main, null);
    public final Setting gradient = new Setting("Gradient", "", (Module)this, (Object)false, this.main, null);
    ...
    private final Setting backgroundColor = new Setting("Background color", "", (Module)this, (Object)new Color(0, 0, 0, 100), this.main, null);
    private final Setting line = new Setting("Line", "", (Module)this, (Object)true, this.main, ArrayList::Method2625);
    private final Setting horizontalLine = new Setting("Horizontal Line", "", (Module)this, (Object)true, this.main, null);
    ...
    private final Setting animationSpeed = new Setting("AnimationSpeed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(5.0f), this.animations, null);
    ...
    private void Method2630(String string, float f, float f2, int n, Module module) {
        ...
        if (((Boolean)this.gradient.getValue()).booleanValue() && ((Boolean)this.rainbow.getValue()).booleanValue()) {
            Class36.Method566(string, 0, f2, this.Method2632(n * 300), 1.0f + ((Float)this.delta.getValue()).floatValue(), (Boolean)this.shadow.getValue(), 0.3f);
        } else if (((Boolean)this.shadow.getValue()).booleanValue()) {
            Class36.Method63(string, 0, f2, (Boolean)this.rainbow.getValue() != false ? this.Method2633(n * 300) : ((Color)this.color.getValue()).getRGB());
        } else {
            Class36.Method555(string, 0, f2, (Boolean)this.rainbow.getValue() != false ? this.Method2633(n * 300) : ((Color)this.color.getValue()).getRGB());
        }
    }
    ...
    private void Method2634(String string, float f, float f2, int n) {
        ...
        Class50.Method817(f3, f2, f3, f2 + (float)((Integer)this.step.getValue()).intValue(), 1.5f, 0, n4);
    }
    ...
    private void Method2627(Class35 class35) {
        ...
        Manager.moduleManager.getModules().values().stream().filter(null).forEach(null);
        this.Method2629();
        ...
        int n2 = 0;
        for (Object class536 : this.Field2155) {
            float f4 = this.corner.getValue() == Class540.Right ? f - (float)Class36.Method259(class536.toString()) - 1.0f : f + 1.0f;
            ...
            if (((Boolean)this.horizontalLine.getValue()).booleanValue() && ((Boolean)this.line.getValue()).booleanValue()) {
                ...
                float f9 = f6 = this.corner.getValue() == Class540.Left ? f + (float)Class36.Method259(null) + 2.0f : f - (float)Class36.Method259(null) - 3.0f;
                ...
                Class50.Method817(f6, f7, f10, f7, 1.5f, 2, n5);
            }
            ++n2;
            f2 = this.renderMode.getValue() == Class331.Up ? f2 + (float)((Integer)this.step.getValue()).intValue() : f2 - (float)((Integer)this.step.getValue()).intValue();
            ++n;
