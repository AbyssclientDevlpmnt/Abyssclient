...
extends Module {
    ...
    public final Setting inverse = new Setting("Inverse", "", (Module)this, (Object)false, this.main, null);
    public final Setting romanNumbers = new Setting("RomanNumbers", "", (Module)this, (Object)true, this.main, null);
    ...
    public final Setting rSpeed = new Setting("RSpeed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.colorLabel, null);
    ...
    private void Method2482(Class35 class35) {
        ...
        if (((Boolean)this.fps.getValue()).booleanValue()) {
            String string5 = "FPS" + ChatFormatting.WHITE + Minecraft.getDebugFPS();
