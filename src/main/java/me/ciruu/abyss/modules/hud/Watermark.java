...
extends Module {
    ...
    public final Setting speed = new Setting("Speed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.colorLabel, null);
    public final Setting saturation = new Setting("Saturation", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.colorLabel, null);
    public final Setting brightness = new Setting("Brightness", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.colorLabel, null);
    public final Setting gradient = new Setting("Gradient", "", (Module)this, (Object)false, this.colorLabel, null);
    ...
    private void Method59(Class35 class35) {
        ...
        if (((Boolean)this.gradient.getValue()).booleanValue() && ((Boolean)this.rainbow.getValue()).booleanValue()) {
            Class36.Method62("Abyss" + ((Boolean)this.version.getValue() != false ? " 1.2.1" : ""), (Boolean)this.staticSetting.getValue() != false ? 2.0f / ((Float)this.scale.getValue()).floatValue() : (float)((Integer)this.x.getValue()).intValue() / ((Float)this.scale.getValue()).floatValue(), (Boolean)this.staticSetting.getValue() != false ? 2.0f / ((Float)this.scale.getValue()).floatValue() : (float)((Integer)this.y.getValue()).intValue() / ((Float)this.scale.getValue()).floatValue(), ((Float)this.speed.getValue()).floatValue(), ((Float)this.saturation.getValue()).floatValue(), ((Float)this.brightness.getValue()).floatValue(), ((Float)this.delta.getValue()).floatValue(), true, 0.0f);
        } else if (((Boolean)this.version.getValue()).booleanValue() && !((Boolean)this.cleanVersion.getValue()).booleanValue()) {
            Class36.Method63("Abyss" + ((Boolean)this.version.getValue() != false ? " 1.2.1" : ""), (Boolean)this.staticSetting.getValue() != false ? 2.0f / ((Float)this.scale.getValue()).floatValue() : (float)((Integer)this.x.getValue()).intValue() / ((Float)this.scale.getValue()).floatValue(), (Boolean)this.staticSetting.getValue() != false ? 2.0f / ((Float)this.scale.getValue()).floatValue() : (float)((Integer)this.y.getValue()).intValue() / ((Float)this.scale.getValue()).floatValue(), (Boolean)this.rainbow.getValue() != false ? this.Method61(0) : ((Color)this.color.getValue()).getRGB());
        } else {
            Class36.Method63("Abyss" + ((Boolean)this.cleanVersion.getValue() != false ? "" + "1.2.1".substring(0, 3) : ""), (Boolean)this.staticSetting.getValue() != false ? 2.0f / ((Float)this.scale.getValue()).floatValue() : (float)((Integer)this.x.getValue()).intValue() / ((Float)this.scale.getValue()).floatValue(), (Boolean)this.staticSetting.getValue() != false ? 2.0f / ((Float)this.scale.getValue()).floatValue() : (float)((Integer)this.y.getValue()).intValue() / ((Float)this.scale.getValue()).floatValue(), (Boolean)this.rainbow.getValue() != false ? this.Method61(0) : ((Color)this.color.getValue()).getRGB());
        }
