...
extends Module {
    ...
    private final Setting obbyRainbowSpeed = new Setting("OSpeed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.obbylabel, null);
    private final Setting obbyRainbowSaturation = new Setting("OSaturation", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.obbylabel, null);
    private final Setting obbyRainbowBrightness = new Setting("OBrightness", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.obbylabel, null);
    ...
    private final Setting bedRainbowSpeed = new Setting("BSpeed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.bedlabel, null);
    private final Setting bedRainbowSaturation = new Setting("BSaturation", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.bedlabel, null);
    private final Setting bedRainbowBrightness = new Setting("BBrightness", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.bedlabel, null);
    ...
    private final Setting extendedRainbowSpeed = new Setting("ESpeed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.extendedlabel, null);
    private final Setting extendedRainbowSaturation = new Setting("ESaturation", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.extendedlabel, null);
    private final Setting extendedRainbowBrightness = new Setting("EBrightness", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.extendedlabel, null);
    ...
    private void Method996(EventPlayerUpdate eventPlayerUpdate) {
        ...
        List list = Class31.Method210(Class30.Method209((EntityPlayer)Globals.mc.player), n, n, false, true, 0);
            if (!Globals.mc.world.getBlockState(blockPos).getBlock().equals(Blocks.AIR) || Globals.mc.world.getBlockState(blockPos.add(0, -1, 0)).getBlock().equals(Blocks.AIR) || !Globals.mc.world.getBlockState(blockPos.add(0, 1, 0)).getBlock().equals(Blocks.AIR) || !Globals.mc.world.getBlockState(blockPos.add(0, 2, 0)).getBlock().equals(Blocks.AIR));
