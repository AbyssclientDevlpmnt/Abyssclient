...
extends Module {
    ...
    private void Method4054(Class66 class66) {
        ...
        for (Entity entity : Globals.mc.world.loadedEntityList) {
            Vec3d vec3d;
            if (!this.Method4056(entity) || (vec3d = Class29.Method1042(entity, class66.Method1789()).subtract(Globals.mc.getRenderManager().viewerPosX, Globals.mc.getRenderManager().viewerPosY, Globals.mc.getRenderManager().viewerPosZ)) == null) continue;
