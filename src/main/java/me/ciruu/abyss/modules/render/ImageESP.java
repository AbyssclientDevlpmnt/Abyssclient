...
extends Module {
    ...
    private void Method2212(Class35 class35) {
        ...
        double d = Globals.mc.player.lastTickPosX + (Globals.mc.player.posX - Globals.mc.player.lastTickPosX) * (double)class35.Method1967();
        double d2 = Globals.mc.player.lastTickPosY + (Globals.mc.player.posY - Globals.mc.player.lastTickPosY) * (double)class35.Method1967();
        double d3 = Globals.mc.player.lastTickPosZ + (Globals.mc.player.posZ - Globals.mc.player.lastTickPosZ) * (double)class35.Method1967();
        ...
        arrayList.sort(Comparator.comparing(ImageESP::Method2220).reversed());
            int n;
            if (entityPlayer == Globals.mc.getRenderViewEntity() || !entityPlayer.isEntityAlive() || !this.Field1821.isBoundingBoxInFrustum(entityPlayer.getEntityBoundingBox()));
            ...
            if (!class502.Field1826 && !class5022.Field1826);
