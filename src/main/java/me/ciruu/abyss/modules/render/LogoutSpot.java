...
extends Module {
    ...
    private final Setting rainbowspeed = new Setting("Speed", "", this, Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(2.0f), this.colorlabel, null);
    private final Setting rainbowsaturation = new Setting("Saturation", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.colorlabel, null);
    private final Setting rainbowbrightness = new Setting("Brightness", "", this, Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), this.colorlabel, null);
    ...
    private Vec3d Method2514(Entity entity, float f) {
        return new Vec3d(this.Method2519(entity.posX, entity.lastTickPosX, f) - Globals.mc.getRenderManager().viewerPosX, this.Method2519(entity.posY, entity.lastTickPosY, f) - Globals.mc.getRenderManager().viewerPosY, this.Method2519(entity.posZ, entity.lastTickPosZ, f) - Globals.mc.getRenderManager().viewerPosZ);
    }
    ...
    private void Method2510(Class179 class179) {
        if (class179.getEra() == Class53.PRE) {
            ...
            this.Field2090.removeIf(arg_0 -> LogoutSpot.Method2523(class179, null));
    ...
    private void Method2508(Class66 class66) {
        block1: {
            ...
            synchronized (list) {
                this.Field2090.forEach(arg_0 -> this.Method2527(class66, null));
            }
        }
    }
    ...
    private void Method2527(Class66 class66, Class545 class545) {
        if (class545.Method2526() != null) {
            ...
            double d = this.Method2520(class545.Method2526().lastTickPosX, class545.Method2526().posX, class66.Method1789()) - Globals.mc.getRenderManager().viewerPosX;
            double d2 = this.Method2520(class545.Method2526().lastTickPosY, class545.Method2526().posY, class66.Method1789()) - Globals.mc.getRenderManager().viewerPosY;
            double d3 = this.Method2520(class545.Method2526().lastTickPosZ, class545.Method2526().posZ, class66.Method1789()) - Globals.mc.getRenderManager().viewerPosZ;
