...
extends Module {
    ...
    private final Setting width = new Setting("Width", "", this, 1, 1, 10, this.mainwindow, null);
    ...
    private List Method2393() {
        return Class31.Method210(Class30.Method209((EntityPlayer)Globals.mc.player));
    }
