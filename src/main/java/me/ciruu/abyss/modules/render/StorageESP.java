...
extends Module {
    ...
    public final Setting echestsColor = new Setting("EnderChestColor", "", (Module)this, (Object)new Color(125, 0, 255, 125), this.mainwindow, null);
    public final Setting chests = new Setting("Chests", "Highlights Chests", this, true);
    public final Setting chestsColor = new Setting("ChestColor", "", (Module)this, (Object)new Color(255, 183, 0, 125), this.mainwindow, null);
    public final Setting shulkers = new Setting("Shulkers", "Highlights Shulkers", this, true);
    public final Setting shulkersColor = new Setting("ShulkerColor", "", (Module)this, (Object)new Color(0, 225, 255, 125), this.mainwindow, null);
    public final Setting furnaces = new Setting("Furnaces", "Highlights Furnaces", this, true);
    public final Setting furnacesColor = new Setting("FurnaceColor", "", (Module)this, (Object)new Color(76, 76, 76, 205), this.mainwindow, null);
    public final Setting hoppers = new Setting("Hoppers", "Highlights Hoppers", this, true);
    public final Setting hoppersColor = new Setting("HopperColor", "", (Module)this, (Object)new Color(255, 0, 140, 125), this.mainwindow, null);
    public final Setting dispensers = new Setting("Dispensers", "Highlights Dispensers", this, true);
    public final Setting dispensersColor = new Setting("DispenserColor", "", (Module)this, (Object)new Color(0, 255, 153, 125), this.mainwindow, null);
