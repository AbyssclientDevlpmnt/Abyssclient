...
extends Module {
    ...
    public final Setting enchantments = new Setting("Enchantments", "", (Module)this, (Object)true, this.mainwindow, null);
    public final Setting durability = new Setting("Durability", "", (Module)this, (Object)true, this.mainwindow, null);
    ...
    public final Setting distance = new Setting("Distance", "", this, Float.valueOf(50.0f), Float.valueOf(1.0f), Float.valueOf(200.0f), this.mainwindow, null);
    ...
    public final Setting thickness = new Setting("Thickness", "", this, Float.valueOf(1.0f), Float.valueOf(1.0f), Float.valueOf(5.0f), this.mainwindow, null);
    public final Setting color = new Setting("Color", "", (Module)this, (Object)Color.BLACK, this.mainwindow, null);
    private final Setting rainbow = new Setting("Rainbow", "", (Module)this, (Object)true, this.mainwindow, null);
    ...
    private Vec3d Method1896(Entity entity, float f) {
        return new Vec3d(this.Method1895(entity.posX, entity.lastTickPosX, f) - Globals.mc.getRenderManager().viewerPosX, this.Method1895(entity.posY, entity.lastTickPosY, f) - Globals.mc.getRenderManager().viewerPosY, this.Method1895(entity.posZ, entity.lastTickPosZ, f) - Globals.mc.getRenderManager().viewerPosZ);
    }
