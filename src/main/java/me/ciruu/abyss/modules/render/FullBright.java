...
extends Module {
    ...
    private void Method1817(EventNetworkPrePacketEvent eventNetworkPrePacketEvent) {
        if (eventNetworkPrePacketEvent.getEra() == Class53.PRE && eventNetworkPrePacketEvent.Method49() instanceof SPacketEntityEffect && ((Boolean)this.effects.getValue()).booleanValue()) {
