...
Listenable {
    ...
    public void Method13() {
        ...
        if (Manager.moduleManager.getModuleByClass(ChatNotifier.class) != null && Manager.moduleManager.isModuleEnabled(ChatNotifier.class)) {
            Globals.printNewChatMessage(ChatFormatting.WHITE + this.Method160() + ChatFormatting.GREEN + " ON");
        }
        if (Manager.moduleManager.getModuleByClass(Notifications.class) != null && ((Boolean)((Notifications)Manager.moduleManager.getModuleByClass(Notifications.class)).toggleFeature.getValue()).booleanValue()) {
            Manager.Field424.Method342(Class128.Info, ChatFormatting.WHITE + this.Method160() + ChatFormatting.GREEN + " enabled!");
        }
    }
    ...
    public void Method15() {
        ...
        if (Manager.moduleManager.getModuleByClass(ChatNotifier.class) != null && Manager.moduleManager.isModuleEnabled(ChatNotifier.class)) {
            Globals.printNewChatMessage(ChatFormatting.WHITE + this.Method160() + ChatFormatting.RED + " OFF");
        }
        if (Manager.moduleManager.getModuleByClass(Notifications.class) != null && ((Boolean)((Notifications)Manager.moduleManager.getModuleByClass(Notifications.class)).toggleFeature.getValue()).booleanValue()) {
            Manager.Field424.Method342(Class128.Info, ChatFormatting.WHITE + this.Method160() + ChatFormatting.RED + " disabled!");
        }
    }
    ...
    private JsonObject Method590() {
        ...
        jsonObject.addProperty("enabled", Boolean.valueOf(!this.Method160().equals("ClickGUI") && this.Method490()));
        jsonObject.addProperty("display", this.Method160());
        ...
        JsonObject jsonObject2 = new JsonObject();
            ...
            jsonObject3.add("value", (JsonElement)null);
    ...
    private void Method593(JsonObject jsonObject) {
        ...
        JsonObject jsonObject3 = this.Method590().getAsJsonObject("settings");
            if (!jsonObject2.has(setting.Method396()));
            try {
    ...
    public void Method596() {
        File file = new File("Abyss/Features/" + Class208.Field486 + "/" + this.Method160() + ".json");
