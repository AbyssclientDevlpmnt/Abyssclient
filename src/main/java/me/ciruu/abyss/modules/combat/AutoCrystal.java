...
extends Module {
    ...
    public final Setting placerange = new Setting("PlaceRange", "Place Range", this, Float.valueOf(6.0f), Float.valueOf(0.0f), Float.valueOf(6.0f), this.placewindow, null);
    private final Setting faceplace = new Setting("FacePlace", "FacePlace", this, Float.valueOf(10.0f), Float.valueOf(0.1f), Float.valueOf(37.0f), this.placewindow, null);
    private final Setting armorbreaker = new Setting("ArmourBreaker", "", this, 0, 0, 100, this.placewindow, null);
    public final Setting mode = new Setting("1.13", "1.13 mode", (Module)this, (Object)false, this.placewindow, null);
    ...
    public final Setting breakrange = new Setting("BreakRange", "Break Range", this, Float.valueOf(6.0f), Float.valueOf(0.0f), Float.valueOf(6.0f), this.breakwindow, null);
    ...
    private Setting renderbox = new Setting("RenderBox", "RenderBox", (Module)this, (Object)Class577.FullBox, this.renderwindow, this::Method3966);
    ...
    public AutoCrystal() {
        ...
        this.fadeticks = new Setting("FadeTicks", "", this, 20, 1, 40, this.renderwindow, null);
        ...
        this.renderrainbow = new Setting("Rainbow", "", (Module)this, (Object)true, this.renderwindow, null);
    ...
    public void Method3990() {
        ...
        if (Manager.moduleManager.isModuleEnabled(KillAura.class) && ((Boolean)((KillAura)Manager.moduleManager.getModuleByClass(KillAura.class)).toggleOnAutoCrystal.getValue()).booleanValue()) {
            ((KillAura)Manager.moduleManager.getModuleByClass(KillAura.class)).Method2886(true);
        }
        this.Field3340 = 20;
    }
    ...
    private void Method4000() {
        this.Field3334 = Class308.Method2664(((Float)this.placerange.getValue()).floatValue(), (Boolean)this.mode.getValue());
    }
    ...
    private void Method4003() {
        ...
        this.Field68 = null;
            float f2;
            float f3;
            if (!Class31.Method1223(blockPos2, Globals.mc.player.getDistanceSq(blockPos2) > Class29.Method114(this.Field3299.getValue() == Class460.Auto ? 6.0 : (double)((Float)this.placetrace.getValue()).floatValue()), 1.0f));
            if (this.Field3299.getValue() == Class460.Manual && ((Boolean)this.placecheck.getValue()).booleanValue() || this.Field3299.getValue() == Class460.Auto) {
                ...
                if (bl && !this.Method4013((Entity)entityEnderCrystal)) {
                    if (this.Method4013((Entity)entityEnderCrystal));
        ...
        if (blockPos == null && ((Boolean)this.recalc.getValue()).booleanValue() && (this.Field3299.getValue() == Class460.Auto || ((Boolean)this.placecheck.getValue()).booleanValue())) {
            ...
            while (object.equals(false)) {
                float f4;
                float f5;
                BlockPos blockPos2 = null;
                if (!Class31.Method1223(blockPos2, Globals.mc.player.getDistanceSq(blockPos2 = (BlockPos)object) > Class29.Method114(((Float)this.RPlaceTrace.getValue()).floatValue()), 1.0f) || !((double)(f5 = Class352.Method1510(blockPos2, (Entity)Globals.mc.player)) + 0.5 < (double)Class30.Method1454((Entity)Globals.mc.player)) && ((Boolean)this.nosuicide.getValue()).booleanValue() || !((Boolean)this.ignoreselfdamage.getValue()).booleanValue() && !(f5 < ((Float)this.maxselfdamage.getValue()).floatValue()) || !((f4 = Class352.Method1510(blockPos2, (Entity)this.Field70)) >= ((Float)this.RMinDamage.getValue()).floatValue()) && !(f4 > Class30.Method1454((Entity)this.Field70)) && (!(Class30.Method1454((Entity)this.Field70) < ((Float)this.faceplace.getValue()).floatValue()) && !this.Method4014(this.Field70) || !(f4 >= 2.0f)) || !(f4 > f)) continue;
                f = f4;
                blockPos = blockPos2;
            }
        }
    ...
    public boolean Method4013(Entity entity) {
        return Globals.mc.world.rayTraceBlocks((Boolean)this.packetpos.getValue() != false ? this.Field3347.add(null) : new Vec3d(Globals.mc.player.posX, Globals.mc.player.posY + (double)Globals.mc.player.getEyeHeight(), Globals.mc.player.posZ), new Vec3d(entity.posX, entity.posY + (double)entity.getEyeHeight(), entity.posZ), false, true, false) == null;
    }
    ...
    private void Method3988(EventNetworkPostPacketEvent eventNetworkPostPacketEvent) {
        if (eventNetworkPostPacketEvent.getPacket() instanceof CPacketPlayer.Position || eventNetworkPostPacketEvent.getPacket() instanceof CPacketPlayer.PositionRotation) {
            ...
            this.Field3347 = new Vec3d(cPacketPlayer.getX(0), cPacketPlayer.getY(0), cPacketPlayer.getZ(0));
        }
    }

    private void Method3987(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        if (eventPlayerUpdateWalking.getEra() != Class53.PRE) {
            return;
        }
    ...
    private void Method3985(EventNetworkPrePacketEvent eventNetworkPrePacketEvent) {
        SPacketSoundEffect sPacketSoundEffect = null;
        if (eventNetworkPrePacketEvent.getPacket() instanceof SPacketSoundEffect && ((Boolean)this.nosounddesync.getValue()).booleanValue()) {
