...
extends Module {
    ...
    private final Setting enemydistance = new Setting("EnemyDistance", "", this, 1, 1, 20, this.mainwindow, null);
    private final Setting mendkey = new Setting("MendKey", "", (Module)this, (Object)new Class207(0), this.mainwindow, null);
    ...
    private void Method1801(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        Object object;
        if (Globals.mc.player == null || Globals.mc.world == null || eventPlayerUpdateWalking.getEra() != Class53.PRE) {
            return;
        }
        ...
        if (this.Field1408.isEmpty()) {
            ...
            if ((object = Globals.mc.player.inventoryContainer.getSlot(6).getStack()) == Items.AIR) {
                if (this.Field1408.isEmpty()) {
                    int n10;
            ...
            } else if (this.Field1410 && object != Items.ELYTRA && this.Field1407.Method50(500L)) {
                if (this.Field1408.isEmpty()) {
            ...
            } else if (!this.Field1410 && object == Items.ELYTRA && this.Field1407.Method50(500L) && this.Field1408.isEmpty()) {
