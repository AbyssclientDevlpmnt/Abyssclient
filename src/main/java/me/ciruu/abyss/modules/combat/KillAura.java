...
extends Module {
    ...
    private final Setting packetrotate = new Setting("PacketRot", "", (Module)this, (Object)true, this.mainwindow, null);
    ...
    public void Method2890() {
        ...
        if (((Boolean)this.toggleOnAutoCrystal.getValue()).booleanValue() && Manager.moduleManager.isModuleEnabled(AutoCrystal.class)) {
            ((AutoCrystal)Manager.moduleManager.getModuleByClass(AutoCrystal.class)).Method3992();
        }
        ...
        if (((Boolean)this.autocriticals.getValue()).booleanValue()) {
            if (!Manager.moduleManager.isModuleEnabled(Criticals.class)) {
                ((Criticals)Manager.moduleManager.getModuleByClass(Criticals.class)).Method4172();
            } else {
                this.Field2325 = true;
            }
        }
    ...
    private void Method2894() {
        int n;
        if (((Boolean)this.onlysword.getValue()).booleanValue() && !Class30.Method2758((EntityPlayer)Globals.mc.player) || Manager.moduleManager.isModuleEnabled(null)) {
            Field1388 = null;
            return;
        }
        ...
        if (!this.Field2322.Method50(493) || ((Boolean)this.stopeating.getValue()).booleanValue() && Globals.mc.player.isHandActive() && (!Globals.mc.player.getHeldItemOffhand().getItem().equals(Items.SHIELD) || Globals.mc.player.getActiveHand() != EnumHand.OFF_HAND)) {
            return;
        }
    ...
    private void Method2884(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        ...
        if (eventPlayerUpdateWalking.getEra() == Class53.PRE && ((Boolean)this.rotate.getValue()).booleanValue()) {
            if (Field1388 != null) {
