...
extends Module {
    ...
    private final Setting mode = new Setting("Mode", "Event mode", this, (Object)Class349.Tick);
    ...
    private void Method1078(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        if (eventPlayerUpdateWalking.getEra() == Class53.PRE && (Integer)this.blockspertick.getValue() == 1 && ((Boolean)this.rotate.getValue()).booleanValue()) {
            this.Method1082();
        }
    }

    private void Method1077(EventPlayerUpdate eventPlayerUpdate) {
        if (((Integer)this.blockspertick.getValue() != 1 || !((Boolean)this.rotate.getValue()).booleanValue()) && this.mode.getValue() == mode.getValue()) {
            this.Method1082();
        }
    }

    private void Method1076(Class26 class26) {
        if (((Integer)this.blockspertick.getValue() != 1 || !((Boolean)this.rotate.getValue()).booleanValue()) && this.mode.getValue() == Class349.Tick) {
            this.Method1082();
        }
    }
