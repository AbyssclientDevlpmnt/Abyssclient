...
public class Class30 {
    ...
    public static Vec3d Method2079(Entity entity, float f) {
        return Class30.Method968(entity, f).subtract(Globals.mc.getRenderManager().viewerPosX, Globals.mc.getRenderManager().viewerPosY, Globals.mc.getRenderManager().viewerPosZ);
    }

    public static Vec3d Method2716(Vec3d vec3d) {
        return new Vec3d(vec3d.x, vec3d.y, vec3d.z).subtract(Globals.mc.getRenderManager().viewerPosX, Globals.mc.getRenderManager().viewerPosY, Globals.mc.getRenderManager().viewerPosZ);
    }
    ...
    public static List Method2721(Vec3d vec3d, int n, boolean bl) {
        ArrayList<Vec3d> arrayList = new ArrayList<Vec3d>();
            BlockPos blockPos = new BlockPos(vec3d).add(vec3d.x, vec3d.y, vec3d.z);
    ...
    public static Object[] Method2734(Vec3d vec3d, int n, boolean bl) {
    ...
    public static List Method2739(int n, EntityPlayer entityPlayer, boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5, boolean bl6) {
        ...
        ArrayList<Vec3d> arrayList2 = new ArrayList<Vec3d>();
            ...
            if (Class31.Method533(blockPos, bl6) != -1);
    ...
    public static Object[] Method2728(int n, boolean bl) {
        List list = Class30.Method2748(n, bl);
        Vec3d[] vec3dArray = new Vec3d[list.size()];
        return list.toArray(vec3dArray);
    }

    public static Object[] Method2740(boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5) {
