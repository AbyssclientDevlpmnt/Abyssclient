...
public final class Class224 {
    public static GuiTextField Field2224;
    ...
    @NotNull
    public static Class137 Field2230;
    ...
    public final void Method1741(int n) {
        this.Field2224.getMaxStringLength();
    }
    ...
    private final void Method2849() {
        block1: {
            if (!this.Method2830() && this.Field2224.getSelectionEnd() != this.Field2224.getCursorPosition()) {
                this.Field2224.getSelectedText();
            }
    ...
    public <DefaultConstructorMarker> Class224(Class137 class137, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
