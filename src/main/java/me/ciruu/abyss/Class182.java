...
extends Module {
    ...
    private final Setting Field413 = new Setting("24HourTime", "", (Module)this, (Object)false, this.Field405, null);
    private final Setting Field414 = new Setting("DateColor", "", (Module)this, (Object)Class184.GRAY, this.Field405, null);
    @EventHandler
    ...
    private void Method499(EventNetworkPrePacketEvent eventNetworkPrePacketEvent) {
        ...
        if (eventNetworkPrePacketEvent.getPacket() instanceof SPacketChat) {
            try {
                if (this.Method501(null, null)) {
