...
extends Module {
    ...
    private void Method2029(EventNetworkPostPacketEvent eventNetworkPostPacketEvent) {
        if (eventNetworkPostPacketEvent.getPacket() instanceof CPacketPlayer) {
            if (this.Field1659.contains((CPacketPlayer)eventNetworkPostPacketEvent.getPacket())) {
                this.Field1659.remove((CPacketPlayer)eventNetworkPostPacketEvent.getPacket());
            } else {
