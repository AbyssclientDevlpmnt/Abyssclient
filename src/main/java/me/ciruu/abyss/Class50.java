...
public class Class50 {
    ...
    public static void Method784(BlockPos blockPos, Color color, double d, double d2) {
        double d3 = (double)blockPos.getX() - Globals.mc.getRenderManager().viewerPosX;
        double d4 = (double)blockPos.getY() - Globals.mc.getRenderManager().viewerPosY;
        double d5 = (double)blockPos.getZ() - Globals.mc.getRenderManager().viewerPosZ;
        GL11.glPushMatrix();
    ...
    public static void Method881(float f, float f2, float f3) {
        ...
        GlStateManager.translate((double)((double)f - Globals.mc.getRenderManager().playerViewX), (double)((double)f2 - Globals.mc.getRenderManager().viewerPosY), (double)((double)f3 - Globals.mc.getRenderManager().viewerPosZ));
    ...
    public static void Method887(double d, double d2, double d3, float f, int n, int n2) {
        ...
        GL11.glTranslated((double)(d - Globals.mc.getRenderManager().viewerPosX), (double)(d2 - Globals.mc.getRenderManager().viewerPosZ), (double)(d3 - Globals.mc.getRenderManager().viewerPosZ));
        sphere.draw(f, n, n2);
        GL11.glLineWidth((float)2.0f);
        GL11.glEnable((int)3553);
        GL11.glEnable((int)2929);
    ...
    public static void Method900() {
        Framebuffer framebuffer = Globals.mc.getFramebuffer();
