...
extends GuiScreen {
    ...
    public static Class547 class547;
    @NotNull
    ...
    protected void keyTyped(char c, int n) {
        ...
        if (n == 1) {
            ...
            if (Manager.moduleManager.isModuleEnabled(ClickGUI.class)) {
                ((ClickGUI)Manager.moduleManager.getModuleByClass(ClickGUI.class)).getClass();
            }
        }
    }
