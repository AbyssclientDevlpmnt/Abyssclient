...
implements Class631 {
    ...
    public void Method3566(int n, int n2, int n3) {
        if (!this.Method4061().Method286() && this.Method4063(n, n2)) {
            if (n3 == 0) {
                ...
                Globals.printChatMessage(this.Field3399.Method490() + " visibility:" + (!this.Field3399.Method492() ? chatFormatting + " ON" : chatFormatting2 + " OFF"));
            }
        }
    }
    ...
    private final void Method4062() {
        ...
        Class36.Method63(this.Field3399.Method3545(), this.Method4058() + (float)3, this.Method291() + this.Method4059() / 3.0f, this.Field3399.Method490() ? Color.WHITE.getRGB() : Class232.Field570.Method722().getRGB());
        if (this.Method290()) {
