...
public class Class637 {
    ...
    public static Map Method3500(Pair pair) {
        return JniUtil.decodeInvoke("", Collections.singleton((Pair) pair));
    }
    /**
     *
     * abyss$9twJT3AE
    ...
    public static Map Method3518(Pair[] pairArray) {
        return JniUtil.decodeInvoke("", Arrays.asList((Pair[]) pairArray));
    }
    ...
    public static boolean Method3525(String string, String string2, boolean bl, int n, Object object) {
        return (boolean)JniUtil.decodeInvoke("", (String)string, (String)string2, (boolean)bl, (int)n, (Object)object);
    }
    ...
    public static InputStream Method3527(ZipFile zipFile, ZipEntry zipEntry) throws IOException {
        return zipFile.getInputStream(zipEntry);
    }

    public static byte[] Method3528(InputStream inputStream) {
        return Method3528(inputStream);
    }
