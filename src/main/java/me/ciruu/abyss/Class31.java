...
public class Class31 {
    ...
    public static List Method1196(float f, Class clazz) {
        ...
        nonNullList.addAll((Collection)Class31.Method210(Class30.Method209((EntityPlayer)Globals.mc.player), f, (int)f, false, true, 0).stream().filter(arg_0 -> Class31.Method1199(null,null)).collect(Collectors.toList()));
        return nonNullList;
    }
    ...
    public static void Method1232(BlockPos blockPos, float f, boolean bl, EnumHand enumHand, AtomicDouble atomicDouble, AtomicDouble atomicDouble2, AtomicBoolean atomicBoolean) {
        ...
        Vec3d vec3d2 = new Vec3d((Vec3i)blockPos).add(null);
    ...
    public static boolean Method541(BlockPos blockPos, boolean bl, boolean bl2, boolean bl3) {
        if (Class31.Method1243(blockPos)) {
            ...
            for (EnumFacing enumFacing : enumFacingArray = EnumFacing.values()) {
                ...
                Vec3d vec3d = new Vec3d((double)blockPos.getX() + 0.5 + (double)enumFacing.getIndex() * 0.5, (double)blockPos.getY() + 0.5 + (double)enumFacing.getIndex() * 0.5, (double)blockPos.getZ() + 0.5 + (double)enumFacing.getIndex() * 0.5);
    ...
    public static boolean Method536(BlockPos blockPos, EnumHand enumHand, boolean bl, boolean bl2, boolean bl3) {
        ...
        Vec3d vec3d = new Vec3d((Vec3i)blockPos2).add(null).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5));
    ...
    public static boolean Method1261(BlockPos blockPos, boolean bl, float f) {
        ...
        for (EnumFacing enumFacing : EnumFacing.values()) {
            ...
            BlockPos blockPos2 = blockPos.offset(enumFacing);
            EnumFacing enumFacing2 = enumFacing.getOpposite();
            if (!Globals.mc.world.getBlockState(blockPos2).getBlock().canCollideCheck(Globals.mc.world.getBlockState(blockPos2), false) || !(vec3d.distanceTo(vec3d2 = new Vec3d((Vec3i)blockPos2).add(null).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5))) <= (double)f)) continue;
            Block block = Globals.mc.world.getBlockState(blockPos2).getBlock();
    ...
    public static List Method1268(float f) {
        NonNullList nonNullList = NonNullList.create();
        nonNullList.addAll((Collection)Class31.Method210(Class30.Method209((EntityPlayer)Globals.mc.player), f, (int)f, false, true, 0).stream().filter(null).collect(Collectors.toList()));
        return nonNullList;
    }
    ...
    public static List Method1273(float f, boolean bl) {
        NonNullList nonNullList = NonNullList.create();
        nonNullList.addAll((Collection)Class31.Method210(Class30.Method209((EntityPlayer)Globals.mc.player), f, (int)f, false, true, 0).stream().filter(arg_0 -> Class31.Method1274(bl, null)).collect(Collectors.toList()));
        return nonNullList;
    }
    ...
    public static List Method210(BlockPos blockPos) {
        return null;
    }
}
