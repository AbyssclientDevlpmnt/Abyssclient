...
extends Class52 {
    ...
    public void Method2457(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        if (eventPlayerUpdateWalking.getEra() != Class53.PRE || Globals.mc.player == null) {
            return;
        }
    ...
    public void Method2459(EventPlayerMove eventPlayerMove) {
        if (eventPlayerMove.getEra() != Class53.PRE || eventPlayerMove.isCancelled() || Globals.mc.player == null) {
            return;
        }
