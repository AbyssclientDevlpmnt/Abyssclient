...
public class Class202 {
    ...
    public static void Method934(float f, float f2) {
        ...
        if (Class202.Method928()) {
            ...
            double d = Class202.Field646.player.posX;
            double d2 = axisAlignedBB.minY;
            double d3 = Class202.Field646.player.posZ;
            double d4 = f4;
            double d5 = f3;
    ...
    public static void Method939(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        ...
        if (bl2) {
            ...
            boolean bl3;
            double d = Class202.Field646.player.posX;
            double d2 = eventPlayerUpdateWalking.getY();
            double d3 = Class202.Field646.player.posZ;
            double d4 = eventPlayerUpdateWalking.getYaw();
            double d5 = eventPlayerUpdateWalking.getPitch();
            boolean bl4 = d * d + d2 * d2 + d3 * d3 > 9.0E-4;
            boolean bl5 = bl3 = d4 != 0.0 || d5 != 0.0;
            if (Class202.Field646.player.isRiding()) {
