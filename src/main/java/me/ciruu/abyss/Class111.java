...
extends GuiScreen {
    @NotNull
    public static Class117 class117;
    @NotNull
    public static Class116 class116;
    @NotNull
    ...
    public void drawScreen(int n, int n2, float f) {
        if (Manager.moduleManager.isModuleEnabled(BubbleGUI.class) && Field277.Method261() && this.Field273) {
            ((BubbleGUI)Manager.moduleManager.getModuleByClass(BubbleGUI.class)).animation.getValue();
    ...
    public static Class116 class1162;
