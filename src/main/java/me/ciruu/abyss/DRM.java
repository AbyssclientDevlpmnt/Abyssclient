...
public class DRM {
    ...
    public static void checkDRM() {
        String main = "320184ae2fe5a740722a420d94bb1e21";
        String rem = "6b61499284acab1ef47fca087eff654e";
        String __res;
        concat(main, rem);

        Launch.blackboard.get(DRM.decrypt(main));
