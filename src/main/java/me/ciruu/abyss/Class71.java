...
implements Class70 {
    ...
    public int Method2553() {
        ...
        if (!this.Field2111) {
            ...
            for (Object t : iterable2) {
                ...
                if (!Intrinsics.areEqual(setting != null ? setting.Field2124 : null, this.Field2116.Method2558()))
                    continue;
            }
    ...
    public void Method2600(int n, int n2, int n3) {
        ...
        if (this.Method2599(n, n2) && n3 == 2) {
            ...
            Globals.printChatMessage(this.Field2122.Method586() + " visibility:" + (!this.Field2122.Method492() ? chatFormatting + " ON" : chatFormatting2 + " OFF"));
            return;
        }
        if (class70 instanceof Class546 || class70 instanceof Class69) {
