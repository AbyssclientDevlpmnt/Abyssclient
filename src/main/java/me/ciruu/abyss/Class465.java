...
public class Class465 {
    ...
    public final List Method3634(String string) {
        return Collections.singletonList(Arrays.stream(this.Field2938.stream().filter(arg_0 -> Class465.Method3635(string, null)).toArray()).findAny());
    }
    public static Class163 class163;
    public Class163 Method3636(String string) {
            if (!class163.Method3632().toLowerCase().startsWith(string.toLowerCase()));
            return class163;
    }
